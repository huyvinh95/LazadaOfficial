package com.vnh.lazadaofficial.ConnectInternet;
...
public class DownloadData extends AsyncTask<String, Void, String> {
    ...
    public DownloadData(String duongdan){
        this.duongdan = duongdan;
        method = true;
    }

    public DownloadData(String duongdan, List<HashMap<String,String>> attrs){
        this.duongdan = duongdan;
        this.attrs = attrs;
        method = false;
    }
    ...
    private String methodGet(HttpURLConnection httpURLConnection){
        ...
        try {
            httpURLConnection.connect(); // mở kết nối
            inputStream = httpURLConnection.getInputStream(); // lấy luồng
            InputStreamReader reader = new InputStreamReader(inputStream); // đọc luồng
